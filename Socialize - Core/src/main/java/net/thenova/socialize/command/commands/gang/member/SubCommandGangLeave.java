...
public final class SubCommandGangLeave extends CommandTemplateGang {

    public SubCommandGangLeave() {
        super("leave", GangRole.MEMBER);
    }

    @Override
    public void run(final Gang gang, final Entity entity, final CommandContext context) {
        gang.getMembers().leave(context, entity);
    }
}
