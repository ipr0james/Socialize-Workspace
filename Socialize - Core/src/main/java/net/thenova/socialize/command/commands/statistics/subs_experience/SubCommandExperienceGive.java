...
@CommandUsage(
        min = 2,
        usage = "experience give <@user> <amount>",
        description = "Give experience to a user"
)
public final class SubCommandExperienceGive extends Command {

    public SubCommandExperienceGive() {
        super("give");
    ...
    protected void execute(final Entity sender, final CommandContext context) {
        ...
        entity.getLevel().add(amount, EntityLevel.Reason.ADMIN);
