package net.thenova.socialize.database.tables.games;
 ...
 */
public final class DBTableGameLottery extends DatabaseTable {

    public DBTableGameLottery() {
        super("games_lottery", new DBSocialize());
    }
    ...
    public void init() {
        registerColumn(
                ...
                new TableColumn("amount", new BigInt())
        );
    }
}
