 ...
 */
public final class DBTableEntityData extends DatabaseTable {

    public DBTableEntityData() {
        super("entity_data", new DBSocialize());
    }

    @Override
    public void init() {
        registerColumn(
                new TableColumn("entity_id", new IntAutoIncrement()).setPrimary(),
