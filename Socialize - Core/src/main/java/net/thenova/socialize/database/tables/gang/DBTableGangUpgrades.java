 ...
 */
public final class DBTableGangUpgrades extends DatabaseTable {

    public DBTableGangUpgrades() {
        super("gang_upgrades", new DBSocialize());
    }
    ...
    public void init() {
        registerColumn(
                ...
                new TableColumn("upgrade_type", new VarChar(VarChar.LENGTH_DEFAULT)),
                new TableColumn("upgrade_level", new Int(2))
        );
    }
}
