 ...
 */
public final class DBTableGangData extends DatabaseTable {

    public DBTableGangData() {
        super("gang_data", new DBSocialize());
    }
    ...
    public void init() {
        registerColumn(
                ...
                new TableColumn("data_key", new VarChar(32)).setNullable(false),
                new TableColumn("data_value", new VarChar(100)).setNullable(true)
        );
    }
}
