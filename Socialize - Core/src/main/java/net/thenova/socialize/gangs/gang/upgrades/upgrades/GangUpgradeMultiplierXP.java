 ...
 */
public final class GangUpgradeMultiplierXP extends GangUpgrade {

    private static final double MULTIPLIER_DEFAULT = 0;
    private static final double MULTIPLIER_INCREMENT = 0.1;

    public GangUpgradeMultiplierXP() {
        super(GangUpgradeType.MULTIPLIER_XP, "XP Multiplier Upgrade",
                new String[] {
                    "Increase the amount of experience",
    ...
    public final void handle(final Gang gang, final int level) {
        gang.getData().set(GangData.Type.MULTIPLIER_EXPERIENCE, this.getMultiplier(level));
